...
<div class="container-fluid">
    <div class="actionDiv">
        <div class="action-title"><h4>Information about the <span>order</span>:</h4></div>
        <div class="showTables">
            <h5>Customer id: <span><?= $order->customer_id ?></span></h5>
            <h5>Port id: <span><?= $order->port_id ?></span></h5>
        </div>
